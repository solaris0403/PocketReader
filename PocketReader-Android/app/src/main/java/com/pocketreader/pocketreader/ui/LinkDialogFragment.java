package com.pocketreader.pocketreader.ui;
...
public class LinkDialogFragment extends DialogFragment {
    ...
    public void show(String title, String message, DialogInterface.OnClickListener positiveCallback, DialogInterface.OnClickListener negativeCallback, FragmentManager fragmentManager) {
        this.title = title;
